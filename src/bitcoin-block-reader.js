...
var BitcoinBlockReader = (function () {
    function BitcoinBlockReader(client, network) {
        this.client = client;
    ...
    BitcoinBlockReader.prototype.getFullBlock = function (index) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, client_functions_1.getMultiTransactionBlock(this.client, index, this.network)];
            });
        });
    };
    BitcoinBlockReader.createFromConfig = function (config) {
        var network = config.network, blockReaderConfig = __rest(config, ["network"]);
