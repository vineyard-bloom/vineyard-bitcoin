...
export declare function getMultiTransactions(client: AsyncBitcoinRpcClient, transactionIds: TxId[], blockIndex: number, network: Network, batchSize?: number): Promise<blockchain.MultiTransaction[]>;
