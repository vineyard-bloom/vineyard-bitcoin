...
function getBlockByIndex(client, index) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, client.getBlockHash(index)];
                case 1:
                    hash = _a.sent();
                    return [2 /*return*/, client.getBlock(hash)];
            }
        });
    });
}
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            promises = transactions
                .filter(function (t) { return t !== exports.liveGenesisTxid; })
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            console.log('t', t);
                            return [4 /*yield*/, client.getRawTransaction(t, true)];
                        case 1:
                            raw = _a.sent();
                            return [2 /*return*/, {
                                    txid: raw.txid,
...
function getMultiTransactionBlock(client, index) {
    return __awaiter(this, void 0, void 0, function () {
        var fullBlock, transactions, newFullBlock;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getBlockByIndex(client, index)];
                case 1:
                    fullBlock = _a.sent();
                    return [4 /*yield*/, getMultiTransactions(client, fullBlock.tx, index)];
                case 2:
